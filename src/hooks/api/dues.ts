...
export function useDuesIOweToUserQuery(myId: string | undefined, userId: string) {
  return useQuery({
...
export function useDuesUserOwesToMeQuery(myId: string | undefined, userId: string) {
  return useQuery({
...
export function useDuesPendingOthersConfirmationQuery(userId: string | undefined) {
  return useQuery({
