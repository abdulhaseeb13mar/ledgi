  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-secondary data-[state=active]:text-white dark:data-[state=active]:border-input dark:data-[state=active]:bg-secondary/80 dark:data-[state=active]:text-white",
